...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_maintainence")) {
  ...
  $updateSQL = sprintf("UPDATE property_details SET STATUS_ID=%s, OWNER_ID = %s, RECEIVER_ID = %s WHERE PROPERTY_ID=%s",
...
<?php include('top.php')?>
    <div >
   <div class="orangehead">Re Sale</div>
...
<div class="phead">Re Sale Information</div>
...
<input name="RECEIVER_ID" type="hidden" value="<?php echo $row_propRS['RECEIVER_ID']; ?>" />
  ...
  <fieldset>
  <legend><span class="lbbhead" style="border-bottom:none">Re Sale Form</span>
  </legend>
  <table align="center" class="form_table" cellpadding="5px" cellspacing="0">
    ...
    <td >
    <div class="label">
    1. By clicking submit button property will be put on website under For Sale category.<br />
    2. This property will be available under For Sale category and will be removed from Sold category.
    </div>
