...
mysql_query("COMMIT");  
  if($Result5){
		$url = "adminpropertysearch.php?MESSAGE=PROPUNDOSALE";
...
<div class="orangehead">Undo Sale</div>
...
<div class="phead">Sale Undo Information</div>
...
<input name="SALE_DETAILS_ID" type="hidden" value="<?php echo $row_propRS['SALE_DETAILS_ID']; ?>" />
  ...
  <fieldset>
  <legend><span class="lbbhead" style="border-bottom:none">Unod Sale Form</span>
  </legend>
...
<div style="width:380px;float:left;padding-left:20px">
  <span style="color:#F00" class="label">Place On Webiste For Sale ?</span><br />
      <p>
        <label>
